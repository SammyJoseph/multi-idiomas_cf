<div class="container pt-5">
    ...
    <div class="row">
        <div class="col-lg-6 mb-5 blog-item">
            ...
            <div class="d-flex align-items-center mb-4">
                ...
                <div class="pl-3">
                    ...
                    <div class="d-flex">
                        ...
                        <small class="mr-2 text-muted"><i class="fa fa-folder"></i> {{ __('Web Design') }}</small>
                        <small class="mr-2 text-muted"><i class="fa fa-comments"></i> 15 {{ __('Comments') }}</small>
                    </div>
                </div>
            </div>
            ...
            <a class="btn btn-outline-primary mt-2 px-3" href="">{{ __('Read More') }} <i class="fa fa-angle-right"></i></a>
        </div>
        <div class="col-lg-6 mb-5 blog-item">
