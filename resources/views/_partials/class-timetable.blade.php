                    ...
                    <table class="table table-bordered table-lg m-0">
                        ...
                        <tbody class="text-center">
                            <tr>
                                ...
                                <td><h5>{{ __('Cardio') }}</h5>John Deo</td>
                                <td></td>
                                <td><h5>{{ __('Crossfit') }}</h5>Adam Phillips</td>
                                <td></td>
                                <td><h5>{{ __('Power Lifting') }}</h5>James Alien</td>
                                <td></td>
                                <td><h5>{{ __('Cardio') }}</h5>John Deo</td>
                            </tr>
                            <tr>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-lg m-0">
                        ...
                        <tbody class="text-center">
                            <tr>
                                <th class="bg-secondary text-white align-middle">6.00am - 8.00am</th>
                                <td class="bg-primary text-white"><h5 class="text-white">{{ __('Cardio') }}</h5>John Deo</td>
                                <td></td>
                                <td><h5>{{ __('Crossfit') }}</h5>Adam Phillips</td>
                                <td></td>
                                <td><h5>{{ __('Power Lifting') }}</h5>James Alien</td>
                    ...
                    <table class="table table-bordered table-lg m-0">
                        ...
                        <tbody class="text-center">
                            <tr>
                                ...
                                <td><h5>{{ __('Cardio') }}</h5>John Deo</td>
                                <td></td>
                                <td class="bg-primary text-white"><h5 class="text-white">{{ __('Crossfit') }}</h5>Adam Phillips</td>
                                <td></td>
                                <td><h5>{{ __('Power Lifting') }}</h5>James Alien</td>
                                <td></td>
                                <td><h5>{{ __('Cardio') }}</h5>John Deo</td>
                    ...
                    <table class="table table-bordered table-lg m-0">
                        ...
                        <tbody class="text-center">
                            <tr>
                                ...
                                <td><h5>{{ __('Crossfit') }}</h5>Adam Phillips</td>
                                <td></td>
                                <td class="bg-primary text-white"><h5 class="text-white">{{ __('Power Lifting') }}</h5>James Alien</td>
                                <td></td>
                                <td><h5>{{ __('Cardio') }}</h5>John Deo</td>
                            </tr>
                            <tr>
