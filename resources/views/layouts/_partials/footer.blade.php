    ...
    <div class="row pt-5">
        ...
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <div class="d-flex flex-column justify-content-start">
                ...
                <a class="text-white mb-2" href="{{ route('features') }}"><i class="fa fa-angle-right mr-2"></i>Our Features</a>
                <a class="text-white mb-2" href="{{ route('classes') }}"><i class="fa fa-angle-right mr-2"></i>Classes</a>
